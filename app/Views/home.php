            ...
            <div id="biblioCarousel" class="carousel slide mx-auto mb-5" data-bs-ride="carousel"
                ...
                <div class="carousel-inner" style="border-radius: 18px;">
                    <div class="carousel-item active">
                        <img src="https://lsjbbtc.wordpress.com/wp-content/uploads/2021/03/p9110108.jpg?w=640"
                            class="d-block mx-auto" alt="Imagen1"
                            style="width:100%; height:1000px; object-fit:contain; background:#fff;">
                    </div>
                    <div class="carousel-item">
                        <img src="https://lsjbbtc.wordpress.com/wp-content/uploads/2021/03/p9110108.jpg?w=640"
                            class="d-block mx-auto" alt="Imagen2"
                            style="width:100%; height:1000px; object-fit:contain; background:#fff;">
                    </div>
                    <div class="carousel-item">
                        <img src="https://lsjbbtc.wordpress.com/wp-content/uploads/2021/03/p9110108.jpg?w=640"
                            class="d-block mx-auto" alt="Imagen3"
                            style="width:100%; height:1000px; object-fit:contain; background:#fff;">
                    </div>
                </div>
