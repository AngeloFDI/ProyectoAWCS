        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" class="form-control" id="buscar-reserva"
    ...
    function mostrarReservas(reservas) {
        ...
        reservas.forEach(function(reserva) {
            ...
            if (reserva.estado === 'activo') {
                html += '<button class="btn-estado btn-completado" onclick="cambiarEstado(' + reserva
                    .id_prestamo + ', \'completado\')">Completar</button>';
                html += '<button class="btn-estado btn-cancelado" onclick="cambiarEstado(' + reserva
                    .id_prestamo + ', \'cancelado\')">Cancelar</button>';
            } else {
                html += '<button class="btn-estado btn-activo" onclick="cambiarEstado(' + reserva.id_prestamo +
                    ', \'activo\')">Activar</button>';
            }
            html += '</td>';
            html += '</tr>';
        });
